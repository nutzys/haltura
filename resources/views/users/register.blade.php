                ...
                <div>
                    <form action="/register/{user}" method="post" class="space-y-2">
                        ...
                        <div class="w-full flex justify-evenly pt-4">
                            ...
                            <a href="/" class="text-black text-base font-normal border-2 border-yellow-700 rounded-full w-fit h-fit py-2 px-4 hover:bg-yellow-700 hover:text-black hover:transition ease-in duration-200">Atpakaļ</a>
                        </div>
                    </form>
                </div>
            </div>
